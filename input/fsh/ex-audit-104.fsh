Instance: ex-auditPixmFeedUpdate-source
...
Instance: ex-auditPixmFeedCreate-manager
...
Instance: ex-auditPixmFeedUpdate-manager
InstanceOf: IHE.PIXm.Feed.Update.Audit.Manager
Title: "Audit Example of ITI-104 Update at Manager"
Description: "Audit Event for Patient Identity Feed FHIR Transaction ITI-104 by the Patient Identifier Cross-reference Manager. The Feed resulted in an Update of a Patient given the feed content, as the given parameter did previously exist."
Usage: #example
* meta.security = http://terminology.hl7.org/CodeSystem/v3-ActReason#HTEST
* type = http://terminology.hl7.org/CodeSystem/audit-event-type#rest "Restful Operation"
* action = #U
