...
When the Patient Identifier Cross-reference Manager receives the Resolve Patient duplicate message of the Patient Identity Feed transaction, it shall replace any references it is maintaining internally to the patient identifier included in the Patient resource to the the patient identifier provided in the 'replaced-by' link. 
