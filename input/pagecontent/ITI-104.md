...
For content body payload see [Patient Mohr Alissa Red](Patient-Patient-MohrAlissa-Red.json.html) example in identifier domain urn:oid:1.3.6.1.4.1.21367.13.20.1000 (Patient.id in resource is due to publication, needs to be omitted).
...
For content body payload see [Patient Mohr Alice Red](Patient-Patient-MohrAlice-Red.json.html) example in identifier domain urn:oid:1.3.6.1.4.1.21367.13.20.1000. (Patient.id in resource is due to publication, needs to be omitted).
