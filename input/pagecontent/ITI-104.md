...
A Patient Identity Source notifies the Patient Identifier Cross-reference Manager for [adding or revising patients](#2310441-add-or-revise-patient) in his patient identifier domain.
...
Patient Identifier Cross-reference Manager SHALL support the Conditional Update based on a patient identifier as outlined in http://hl7.org/fhir/http.html#cond-update. 
...
The Patient Identifier Cross-reference Manager should check that the Patient Identifier Cross-reference Source uses an authorized Patient Identifier Domain.
