...
The Patient Identifier Cross-reference Manager when grouped with ATNA Secure Node or Secure Application actor may check that the Patient Identifier Cross-reference Source uses an
authorized Patient Identifier Domain.
